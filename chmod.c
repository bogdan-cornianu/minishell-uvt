 ...
 * 
 * @param mode     - new mode
 * @param **fdname - file or directory
 * 	
...
/**
 * function executed to change parse int to mode_t
 * 
 * @param mode   - int mode to be converted to mode_t
 * 	
 * @return mode_t
 */
...
int main (int argc, char **argv) {
    ...
    /**
	 * @see run command if new mode and file/dir exists in arguments
	 * @see chmod_default (atoi(argv[1]), argv[2]);
	 */
    if (argc == 3) {
